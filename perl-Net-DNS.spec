...
Source0  : https://cpan.metacpan.org/authors/id/N/NL/NLNETLABS/Net-DNS-1.40.tar.gz
...
%prep
%setup -q -n Net-DNS-1.40
cd %{_builddir}/Net-DNS-1.40
pushd ..
cp -a Net-DNS-1.40 buildavx2
popd

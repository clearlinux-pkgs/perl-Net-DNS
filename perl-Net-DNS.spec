...
Source0  : https://cpan.metacpan.org/authors/id/N/NL/NLNETLABS/Net-DNS-1.43.tar.gz
...
%prep
%setup -q -n Net-DNS-1.43
cd %{_builddir}/Net-DNS-1.43
pushd ..
cp -a Net-DNS-1.43 buildavx2
popd

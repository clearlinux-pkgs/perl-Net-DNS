...
Source0  : https://cpan.metacpan.org/authors/id/N/NL/NLNETLABS/Net-DNS-1.44.tar.gz
...
%prep
%setup -q -n Net-DNS-1.44
cd %{_builddir}/Net-DNS-1.44
pushd ..
cp -a Net-DNS-1.44 buildavx2
popd
pushd ..
cp -a Net-DNS-1.44 buildapx
popd
